  ...
  return (
    <div className="w-screen overflow-x-hidden min-h-screen text-[#FF4444] bg-[#FFEBEB] flex flex-col relative font-inter px-4 sm:px-8 md:px-16 lg:px-32 xl:px-48">
      <header className="w-full max-w-4xl mx-auto px-4 py-8 relative">
        ...
        <nav className="absolute right-0 top-0 m-4 sm:m-8 md:m-16 flex flex-col space-y-2 text-[#FF4444] font-gilroy font-bold text-2xl tracking-wide leading-tight">          <span className="nav-link opacity-50 cursor-not-allowed">/home</span>
